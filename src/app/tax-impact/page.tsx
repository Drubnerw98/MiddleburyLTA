...
export default function TaxImpactPage() {
  ...
  // ✅ Clean shorthand formatter with overflow cap
    ...
    <main className="max-w-2xl mx-auto px-6 py-12 space-y-10">
      ...
      <div className="bg-[#2c3545]/90 border border-white/10 rounded-lg p-6 shadow-md backdrop-blur space-y-6">
        ...
        <div className="space-y-2">
          ...
          <div className="flex space-x-2 items-center">
            ...
            <input
              ...
              className="flex-1 bg-gray-800 text-white border border-blue-700 rounded-md px-4 py-2 focus:outline-none focus:ring focus:border-blue-400"
            ...
            <button
              onClick={handleReset}
              className="bg-gray-700 hover:bg-gray-600 text-white px-3 py-2 rounded-md font-medium"
            >
              Reset
            </button>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-center">
          <div className="bg-blue-900/60 rounded-md p-4">
      ...
      {/* Placeholder for future explanation section */}
